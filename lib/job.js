...
Job.prototype.computeNextRunAt = function() {
  ...
  if(interval) {
    this.computeFromInterval(interval);
  } else if(repeatAt) {
    this.computeFromRepeatAt(repeatAt);
  }

  return this;
};

Job.prototype.computeFromInterval = function(interval) {
...
Job.prototype.computeFromRepeatAt = function(repeatAt) {
  var lastRun = this.attrs.lastRunAt || new Date();
